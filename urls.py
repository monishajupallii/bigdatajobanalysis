"""two_stage_job_title_identification URL Configuration
...
from two_stage_job_title_identification import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Job_Title_Identification_Type/$', remoteuser.Predict_Job_Title_Identification_Type, name="Predict_Job_Title_Identification_Type"),
    ...
    url(r'^View_Prediction_Of_Job_Title_Identification_Type_Ratio/$', serviceprovider.View_Prediction_Of_Job_Title_Identification_Type_Ratio, name="View_Prediction_Of_Job_Title_Identification_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Job_Title_Identification_Type/$', serviceprovider.View_Prediction_Of_Job_Title_Identification_Type, name="View_Prediction_Of_Job_Title_Identification_Type"),
