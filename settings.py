...
ROOT_URLCONF = 'two_stage_job_title_identification.urls'
...
WSGI_APPLICATION = 'two_stage_job_title_identification.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'two_stage_job_title_identification',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
